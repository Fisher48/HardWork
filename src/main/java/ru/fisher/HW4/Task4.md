...
### 2-й пример это GeoCoderService - Сервис отвечает за прямое и обратное геокодирование через внешние API (OpenRouteService и Яндекс)
...
И в целом вынос логики, разграничение обязанностей сервисов это нужные вещи, 
