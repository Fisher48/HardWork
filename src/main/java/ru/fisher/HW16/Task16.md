...
Реализовал тест по созданию заказа, они проверяют как работает скидка при создании заказа в зависимости от конкурентного типа пользователя и типа товара.
```java
@SpringBootTest
@Transactional
